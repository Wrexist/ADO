...
echo "▶ capturing /command, /ops, /prompts, /workflows, /automations, /repositories/sentinel, /settings, /setup → $OUT/"
node scripts/screenshot.mjs http://localhost:5173 "$OUT" "/command,/ops,/prompts,/workflows,/automations,/repositories/sentinel,/settings,/setup"
RC=$?
